...
import 'package:restaurant_app/unidades/pedidos/data/model/feature_ubicacion_modelo.dart';
...
class UbicacionRepositorioImpl implements UbicacionRepositorio {
  ...
  @override
  Future<List<String>> obtenerSugerencias(String query) async {
    ...
    if (response.statusCode == 200) {
      final data = json.decode(response.body);
      return (data['features'] as List).map((feature) => feature['properties']['full_address'] as String).toList();
    } else {
